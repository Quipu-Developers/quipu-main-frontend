...
function AppContent() {
  ...
  return (
    ...
    <div basename={process.env.PUBLIC_URL}>
      {!isJoinQuipuPage && !isDetailPage && !isShowcaseMainPage && !isInterveiwPage && (
        <nav className="navbar">
          ...
          <div className="navbar__menu--pc">
            <ul>
              ...
              <li><Link to="activity" smooth={true} duration={100}>activity</Link></li>
              <li><Link to="recommend-site" smooth={true} duration={100}>recommend site</Link  ></li>
          ...
          <div className={`navbar__menu--mobile ${menuOpen ? 'open' : ''}`}>
            <ul>
              <li style={{ marginTop: '80px' }}><Link to="home" smooth={true} duration={100} onClick={closeMenu}>home</Link></li>
              <li><Link to="about" smooth={true} duration={100} onClick={closeMenu}>about</Link></li>
              <li>
                <div className="activity-menu">
                  <Link to="activity" smooth={true} duration={100} onClick={closeMenu}>activity</Link>
              ...
              <li><Link to="recommend-site" smooth={true} duration={100} onClick={closeMenu}>recommend site</Link></li>
              <li>
      ...
      <Routes>
        <Route path="/" element={
          <>
            ...
            <Element name="activity"><Activity /></Element>
            <Element name="recommend-site"><RecommendSite /></Element>
