...
function App() {
  ...
  const [joinquipu, setJoinquipu] = useState(false);
  ...
  return (
    <Router basename={process.env.PUBLIC_URL}>
      <nav className="navbar">
        ...
        <div className="navbar__menu--pc">
          <ul>
            ...
            <li>
              <NavLink to="/#activity" smooth>
                activity
              </NavLink>
            </li>
            <li>
              <NavLink to="/#recommend-site" smooth>
                recommend site
              </NavLink>
            </li>
            <li>
              <NavLink onClick={() => setJoinquipu(!joinquipu)}>join Quipu</NavLink>
            </li>
          </ul>
        </div>

        <NavLink className="mobile-joinquipu" onClick={() => setJoinquipu(!joinquipu)}>
          join Quipu
        </NavLink>
        ...
        <div className={`navbar__menu--mobile ${menuOpen ? 'open' : ''}`}>
          <ul>
            ...
            <li>
              <NavLink to="/recommend-site" onClick={closeMenu}>
                recommend site
              </NavLink>
            </li>
          </ul>
      ...
      {joinquipu && <Recruit setJoinquipu={setJoinquipu} />}
