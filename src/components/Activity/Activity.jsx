...
function Activity() {
    ...
    const images = [["/img/파이썬스터디-min2.png", "/img/웹개발스터디-min2.jpg", "/img/공모전-min2.png"], 
                    ["/img/친목1-min2.jpg", "/img/친목2-min2.jpg", "/img/친목3-min2.jpg"], 
                    ["/img/mt1-min2.jpg", "/img/mt2-min2.jpg", "/img/mt3-min2.jpg"]];
