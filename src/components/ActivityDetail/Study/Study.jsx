...
const 웹개발입문 = {
    ...
    links: {'계획서':"https://quipu-web-basic.notion.site/d2813f6ed0bc4c9d991eba3c2f32f9d6?pvs=4"},
    leaders: ['이예나', '이제민'],
    members: ['모집 예정'],
    allMembers: ['모집 예정'],
...
const 퀴푸포럼웹개발 = {
    ...
    links: {"계획서":"https://quipu-web-forum.notion.site/02-29-43ca936739434d4083e1c1c3c0c1e6b8?pvs=4"},
    leaders: ['이예나', '이제민'],
    members: ['김예영', '김은지', '차준섭'],
...
const 퀴푸메인웹개발 = {
    ...
    links: { "멤버 소개 및 개발일지": "https://quipu-dev.notion.site/main-website-c8661a4633804bfdaadb105c86d2df1e?pvs=4", "깃허브": "https://github.com/Quipu-Developers" },
    leaders: ['이예나'],
