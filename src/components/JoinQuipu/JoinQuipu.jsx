...
function JoinQuipu() {
  ...
  const handleSubmit = async (event) => {
    ...
    axios
      .post('https://quipu-main-server.site/api/data', formData, {
        headers: {
    ...
    <div>
      ...
      <div className="JoinQuipu-container">
        <div className="member">
          ...
          <div className="join-notice">
            <div className="join-notice__icon">
              <div className="join-notice__icon--top1">
                <p
                  style={{ color: 'red', marginTop: '1.5px', marginLeft: '10px', fontSize: '8px' }}
                >
                  ●
                </p>
                <p
              ...
              <div className="join-notice__icon--body">
                <p>
                  신입부원의 경우 <span style={{ color: '#448FFF' }}>New Entry</span> / <br></br>{' '}
                  기존부원의 경우 <span style={{ color: '#448FFF' }}>Re-Entry</span>로 체크 후
                </p>
                <p>지원서 작성해주세요!</p>
                <p style={{ color: 'whitesmoke' }}>또한, 지원서는 회비 납부 이후 제출바랍니다 :)</p>
                <p>
                  (신규회원 : <span style={{ fontWeight: 900 }}>20,000</span>원 / 기존회원 :{' '}
                  <span style={{ fontWeight: 900 }}>25,000</span>원)
                </p>
                ...
                <p>
                  <span style={{ color: '#448FFF' }}>*</span>는 필수입력 칸입니다.{' '}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="field">
            <b>
              이름 <span style={{ color: '#448FFF' }}>*</span>
            </b>
          ...
          <div className="field">
            <b>
              학번 <span style={{ color: '#448FFF' }}>*</span>
            </b>
            <input
              type="tel"
              maxLength={10}
          ...
          <div className="field major">
            <b>
              학과 <span style={{ color: '#448FFF' }}>*</span>
            </b>
            <div>
              <select
                value={major}
              ...
              >
                ...
                <option value="경영대학" disabled>
                  🏫 경영대학
                </option>
                <option value="경영학부">경영학부</option>
                <option value="인문대학" disabled>
                  🏫 인문대학
                </option>
          ...
          <div className="field tel-number">
            <b>
              전화번호 <span style={{ color: '#448FFF' }}>*</span>
            </b>
            <div>
              <input
                type="tel"
          ...
          <div className="checkbox">
            <label htmlFor="checkbox-input-reviewed">
              입력하신 정보가 정확한지 다시 한 번 확인해주세요!
            </label>
            <input
              id="checkbox-input-reviewed"
              type="checkbox"
              checked={reviewed}
          ...
          <div className="checkbox">
            <label htmlFor="checkbox-input-paidFee">
              폼 제출 전, 회비를 미리 납부해 주시기 바랍니다!
            </label>
            <input
              id="checkbox-input-paidFee"
              type="checkbox"
              checked={paidFee}
