    ...
    return (
        <div className="joinquipu-container">
            ...
            <div className="joinquipu-nav">
                <img src={process.env.PUBLIC_URL + "/logo_main.png"} onClick={() => navigate('/')}></img>
            </div>
            <div className="joinquipu-content">
                ...
                {/* 일반 부원 모집 폼 */}
                {
                    ...
                    <>
                        ...
                        <div className="joinquipu-notice">
                            <img src={process.env.PUBLIC_URL + "/JoinQuipu-img/robot.png"} />
                            <div>
                                <p style={{ color: 'black' }}> 환영합니다!</p>
                                <p style={{ color: 'black' }}>지원서는 <span style={{ color: 'red' }}>회비 납부 이후</span> 제출바랍니다 :)</p>
                                <p style={{ color: 'black' }}>(회비 : 20,000원)</p>
                                <p style={{ color: 'black' }} onClick={() => { copyToClipboard('1234567') }}>
                                    납부 계좌 : 카카오뱅크&nbsp;
                ...
                {/* 개발 부원 모집 폼 */}
                {
                    ...
                    <>
                        ...
                        <div className="field">
                            <p><label style={{ fontWeight: 'bold' }}>포토폴리오 PDF</label></p>
